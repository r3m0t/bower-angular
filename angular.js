/**
 * @license AngularJS v1.3.0-local+sha.5cd5e9e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.5cd5e9e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.5cd5e9e',    // all of these placeholder strings will be replaced by grunt's
