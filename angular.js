/**
 * @license AngularJS v1.2.14-build.local+sha.1289c58
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.14-build.local+sha.1289c58/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.14-build.local+sha.1289c58',    // all of these placeholder strings will be replaced by grunt's
