/**
 * @license AngularJS v1.3.1-local+sha.e4c58cc
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.1-local+sha.e4c58cc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.1-local+sha.e4c58cc',    // all of these placeholder strings will be replaced by grunt's
